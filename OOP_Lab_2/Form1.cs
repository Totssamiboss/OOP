...
namespace OopLabApp
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            // --- НОВОЕ: Выпадающий список выбора функции класса ---
        ...
        private void Grid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (selected is Camera cam)
                {
                    ...
                    // Добавляем СТРОГО твои методы для Камеры
                ...
                else if (selected is Light light)
                {
                    ...
                    // Добавляем СТРОГО твои методы для Света
        ...
        private void BtnWork_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Показываем в MessageBox именно то, что вернул твой класс
